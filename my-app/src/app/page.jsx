...
// ✅ استخدم مسار الصورة بدلاً من الاستيراد المباشر
const heroImage = "/heroImage.png";

// ✅ تأكد من أن `motion.div` يستخدم `viewport={{ once: true }}`
    ...
    <div >
      ...
      >
        <div className={style.col}>
          ...
          >
            Discover a world of endless shopping possibilities at our online store. Browse,
            choose, and order your favorite products from the comfort of your home.
          </motion.p>
          <motion.div
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
